                    ...
                    <div class="container-fluid list-table">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @endif
                              	<form action="admin/product/add" method="POST" enctype="multipart/form-data" class="form-horizontal">
								  ...
								  <div class="form-group">
								    ...
								    <div class="col-sm-10">
								      <input type="text" class="form-control" name="unit_price" id="inputPassword3" placeholder="Price">
								    </div>
								  </div>
								  <div class="form-group">
								    <label for="txtgia" class="col-sm-2 control-label">Giảm giá</label>
								    <div class="col-sm-10">
								      <input type="text" class="form-control" name="promotion_price" id="inputPassword3" placeholder="Price">
								    </div>
								  </div>
								  <div class="form-group">
